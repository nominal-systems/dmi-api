...
export class MigrateRefsAndProviderOptions1693444480666 implements MigrationInterface {
    name = 'MigrateRefsAndProviderOptions1693444480666'
    ...
    public async down (queryRunner: QueryRunner): Promise<void> {
        for (const provider of providersData) {
            await queryRunner.query(`DELETE FROM \`provider_option\` WHERE \`providerId\` = '${provider.id}'`)
        }
