...
export class ProviderRefsAndProviderOptions1693861926215 implements MigrationInterface {
    ...
    public async up (queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`provider_ref\` (\`id\` int NOT NULL AUTO_INCREMENT, \`code\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`species\` varchar(255) NULL, \`type\` enum ('species', 'breed', 'sex') NOT NULL, \`provider\` varchar(255) NULL, \`refId\` int NULL, INDEX \`idx_species_code\` (\`code\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
